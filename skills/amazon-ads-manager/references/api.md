...
- Managed installs use the connected system credential. Environment-mode developers set `NEXSCOPE_AUTH_MODE=environment`, `NEXSCOPE_PROXY_BASE`, and `NEXSCOPE_API_KEY`.
