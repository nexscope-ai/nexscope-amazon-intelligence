---
name: amazon-opportunity-search-by-metrics
description: "Find Amazon niches and keywords matching business metrics such as growth, competition, concentration, pricing, demographics, or review pain points."
---
...
Managed installs use the connected system credential. Environment-mode developers set `NEXSCOPE_AUTH_MODE=environment` and `NEXSCOPE_API_KEY`. If authentication fails (401/402) or you see insufficient balance errors, visit https://www.nexscope.ai/help/skills-external-access?co-from=skillNS to get an API Key or top up credits.
