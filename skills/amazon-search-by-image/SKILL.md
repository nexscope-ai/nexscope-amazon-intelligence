...
description: "Find visually similar products on Amazon from an image URL, with optional Keepa sales enrichment."
---
...
Managed installs use the connected system credential. Environment-mode developers set `NEXSCOPE_AUTH_MODE=environment` and `NEXSCOPE_API_KEY`. Visit https://www.nexscope.ai/help/skills-external-access?co-from=skillNS to manage credits.
