#!/usr/bin/env python3
import sys as _nexscope_runtime_sys
from pathlib import Path as _NexScopePath
_nexscope_runtime_sys.path.insert(0, str(_NexScopePath(__file__).resolve().parents[3]))
from runtime.credentials import activate as _nexscope_activate
_nexscope_activate()
