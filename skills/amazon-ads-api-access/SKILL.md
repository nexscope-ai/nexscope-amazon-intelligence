---
name: amazon-ads-api-access
description: "Authorize Amazon Ads accounts and inspect connection or advertising-profile metadata. Use for Amazon Ads authentication and profile access, not general account authentication."
---
...
- Managed installs load the gateway and device credential from the system credential store. Developers using environment mode set `NEXSCOPE_AUTH_MODE=environment`, `NEXSCOPE_PROXY_BASE`, and `NEXSCOPE_API_KEY`.
